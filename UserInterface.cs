...
namespace LemonadeStand
{
    class UserInterface
    {
        ...
        //does this
        public string DisplayUserInterface()
        {
            Console.WriteLine("Welcome to the lemonade stand");
            Console.WriteLine("You have 7 days to make as much money as possible");
            Console.WriteLine("You’ll have complete control over your business, including pricing, quality control, inventory control, and purchasing supplies.");
